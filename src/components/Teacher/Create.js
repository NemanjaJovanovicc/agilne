...
class Create extends Component
{
    ...
    checkValidation(fields) {
		...
		if(fields.name.length === 0 || fields.mobile_no.length === 0 || fields.email.length === 0 || fields.surname.length === 0 || fields.address.length === 0 || fields.address.jmbg === 0) {
			return true;
		} else {
			return false;
		}
			  	...
			  	<div className="modal-dialog" role="document">
			    	<div className="modal-content">
			      		<div className="modal-header">
			        		<h5 className="modal-title">Novi Instruktor</h5>
			        ...
			        <form onSubmit={this.handleInsert}>
			      		<div className="modal-body">
                            ...
                            <label htmlFor="gender" className="col-form-label">Pol:</label>
                                <Dropdown style={{marginLeft: "10px", marginTop: "3px"}}>
                                    <Dropdown.Toggle title={this.state.gender == 'Muški' ? 'Muški' : 'Ženski'} btnStyle="link"/>
                                    <Dropdown.Menu>
                                        <MenuItem onSelect={() => {
                                                this.setState({
                                                    gender : 'Muški'
                            ...
                            <div className="form-group" style={{marginBottom: '5px'}}>
                                <label htmlFor="coursTypes" className="col-form-label">Naziv kandidata:</label>
                            ...
                            <div className="form-group" style={{marginBottom: '5px'}}>
                                <label htmlFor="coursTypes" className="col-form-label">Kurs:</label>
			      		...
			      		<div className="modal-footer">
			        		...
			        		<button type="submit" className="btn btn-primary btn-sm">Sačuvaj instruktora</button>
			      		</div>
			   		</form>
			    	</div>
			  	</div>
