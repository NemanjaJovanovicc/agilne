      ...
      return(
          	<div className="card mt-4">
			    <div className="card-header">
			        <h4 className="card-title"> Kandidati </h4>
                    {userLoggedIn &&
                        <button type="button" className="btn btn-primary btn-sm pull-right" data-toggle="modal" data-target="#addModal" onClick={this.handleDeleted()}> Dodaj kandidata </button>
                    }
			    </div>
                        ...
                        <table className="table table-bordered">
                            ...
                            {this.state.studentData.map((user, i) => (
                                <tr key={i}>
                                    ...
                                    {userLoggedIn &&
                                        <td>
                                            <button className="btn btn-info btn-sm mr-2" onClick={this.handleEditUser.bind(this, user.id)} data-toggle="modal" data-target="#editModal"> Izmeni </button>
                                            <button className="btn btn-danger btn-sm" onClick={this.handleDeleteUser.bind(this, {position: i, id: user.id})}> Izbriši </button>
                                        </td>
                                    }
                                </tr>
                            ))}
