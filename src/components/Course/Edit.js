			  	...
			  	<div className="modal-dialog" role="document">
			    	<div className="modal-content">
			      		<div className="modal-header">
			        		<h5 className="modal-title">Update informacije o kursu</h5>
                    ...
                    <div className="modal-body">
                            ...
                            <div className="form-group">
			            		...
			            		<input type="text" className={`form-control form-control-sm ${this.hasErrorFor('capacity') ? 'is-invalid' : ''}`}
			            		 id="capacity" name="capacity" placeholder="Kapacitet" onChange={this.handleInputFieldChange} value={this.state.capacity}/>
                            ...
                            <div className="form-group" style={{marginBottom: '5px'}}>
                                ...
                                <Dropdown style={{marginLeft: "10px", marginTop: "3px"}} className={`${this.hasErrorFor('courseType') ? 'is-invalid' : ''}`}>
                                    <Dropdown.Toggle title={this.state.courseType === null || typeof this.state.courseType === 'undefined' ? 'Naziv kandidata' : this.state.courseType.name} btnStyle="link"/>
                                    <Dropdown.Menu>
                            ...
                            <div className="form-group">
                                <label htmlFor="dateOfStart" className="col-form-label" style={{display: 'block'}}>Datum startovanja grupe:</label>
