...
class Index extends Component
{
	...
	handleDelete(itemToDelete) {
        deleted = true;
        var referenceToDelete = firebase.database().ref('course').orderByChild('id').equalTo(itemToDelete.id);
        ...
        toastr.error('Course has been deleted successfully!', {position : 'top-right', heading: 'Done'});
	}
      ...
      return(
          	<div className="card mt-4">
			    <div className="card-header">
			        <h4 className="card-title"> Kursevi </h4>
                    {userLoggedIn &&
                        <button type="button" className="btn btn-primary btn-sm pull-right" data-toggle="modal" data-target="#addModal" onClick={this.handleDeleted()}> Dodaj kurs </button>
                    }
			    </div>
			        ...
			        <div className="col-md-12">
                        <table className="table table-bordered">
                            <thead>
                                <tr>
                                    <th> Naziv kursa </th>
                                    <th> Kapacitet grupe </th>
                                    <th> Datum startovanja kursa </th>
                                    <th> Naziv kandidata </th>
                                    <th> Instruktor </th>
                                    <th> Actions </th>
                                </tr>
                            </thead>
